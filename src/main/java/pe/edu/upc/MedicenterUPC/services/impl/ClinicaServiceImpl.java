...
import pe.edu.upc.MedicenterUPC.repositories.ClinicaRepository;
...
public class ClinicaServiceImpl implements ClinicaService,Serializable{
	...
	@Transactional(readOnly = true)
	@Override 
	public List<Clinica> findByNombrec(String nombrec) throws Exception {
		// TODO Auto-generated method stub
		return clinicaRepository.findByNombrecContaining(nombrec);
	}
	@Transactional(readOnly = true)
	@Override
